...
window.colors = {
  ...
  light: {
    primary: 'rgba(var(--rgb-primary-color), 0.1)',
    secondary: 'rgba(var(--rgb-second-color), 0.1)',
    success: 'rgba(var(--rgb-success-color), 0.1)',
    info: 'rgba(var(--rgb-info-color), 0.1)',
    warning: 'rgba(var(--rgb-warning-color), 0.1)',
    danger: 'rgba(var(--rgb-error-color), 0.1)',
    dark: '#4b4b4b1a'
  }
};
