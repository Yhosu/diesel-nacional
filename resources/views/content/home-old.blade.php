                    ...
                    <div class="col-md-6">
                        <div class="image-collge-wrap fl-wrap">
                            <div class="main-iamge">
                                <img src="https://restabook.kwst.net/dark/images/all/3.jpg"   alt="">
                            </div>
                            <div class="images-collage-item" style="width:65%" data-position-left="68" data-position-top="-15" data-zindex="2" data-opacity="1.0"><img src="https://restabook.kwst.net/dark/images/all/8.jpg" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="content-inner fl-wrap">
                                <div class="content-front">
                                    <div class="cf-inner">
                                        <div class="bg "  data-bg="https://restabook.kwst.net/dark/images/services/1.jpg"></div>
                                        <div class="overlay"></div>
                                        <div class="inner">
                        ...
                        <div class="col-md-4">
                            <div class="content-inner fl-wrap">
                                <div class="content-front">
                                    <div class="cf-inner">
                                        <div class="bg "  data-bg="https://restabook.kwst.net/dark/images/services/2.jpg"></div>
                                        <div class="overlay"></div>
                                        <div class="inner">
                        ...
                        <div class="col-md-4">
                            <div class="content-inner fl-wrap">
                                <div class="content-front">
                                    <div class="cf-inner">
                                        <div class="bg "  data-bg="https://restabook.kwst.net/dark/images/services/3.jpg"></div>
                                        <div class="overlay"></div>
                                        <div class="inner">
                        ...
                        <div class="col-md-3">
                            <div class="hero-menu_header fl-wrap">
                                <ul class="tabs-menu     no-list-style change_bg">
                                    <li class="current"><a href="#tab-1" data-bgtab="https://restabook.kwst.net/dark/images/bg/4.jpg"><span>01.</span>Main dishes</a></li>
                                    <li><a href="#tab-2" data-bgtab="https://restabook.kwst.net/dark/images/bg/6.jpg"><span>02.</span>Starter</a></li>
                                    <li><a href="#tab-3" data-bgtab="https://restabook.kwst.net/dark/images/bg/7.jpg"><span>03.</span>Desserts</a></li>
                                    <li><a href="#tab-4" data-bgtab="https://restabook.kwst.net/dark/images/bg/5.jpg"><span>04.</span>Sea Food</a></li>
                                    <li><a href="#tab-5" data-bgtab="https://restabook.kwst.net/dark/images/bg/9.jpg"><span>05.</span>Drinks</a></li>
                                </ul>
                            </div>
                        </div>
                        <!--  hero-menu_header  end-->
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testi-item fl-wrap">
                                    <div class="testi-avatar"><img src="https://restabook.kwst.net/dark/images/avatar/2.jpg" alt=""></div>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-item fl-wrap">
                                    <div class="testi-avatar"><img src="https://restabook.kwst.net/dark/images/avatar/3.jpg" alt=""></div>
                                    <div class="testimonilas-text fl-wrap">
                                        <h3>Frank Dellov</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-item fl-wrap">
                                    <div class="testi-avatar"><img src="https://restabook.kwst.net/dark/images/avatar/4.jpg" alt=""></div>
                                    <div class="testimonilas-text fl-wrap">
                                        <h3>Centa Simpson</h3>
                                        <div class="star-rating" data-starrating="5"> </div>
                                        <p>"Vestibulum orci felis, ullamcorper non condimentum non, ultrices ac nunc. Mauris non ligula suscipit, vulputate mi accumsan, dapibus felis. Nullam sed sapien dui. Nulla auctor sit amet sem non porta. "</p>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-item fl-wrap">
                                    <div class="testi-avatar"><img src="https://restabook.kwst.net/dark/images/avatar/5.jpg" alt=""></div>
                                    <div class="testimonilas-text fl-wrap">
